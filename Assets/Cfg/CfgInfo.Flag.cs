...
namespace Assets
{
    public partial class CfgInfo
    {
        public class Flag
        {
            ...
            public bool carrierOnRadar;
            public bool carrierLineOfSight;
            ...
            public Flag(ref Dictionary<string, Dictionary<string, string>> stringTree)
            {
                ...
                carrierOnRadar = Parser.GetBool("CarrierOnRadar");
                carrierLineOfSight = Parser.GetBool("CarrierLineOfSight");
                ...
                allowSafety = Parser.GetBool("AllowSafety");
