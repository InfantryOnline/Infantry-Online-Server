...
namespace InfMapEditor.Rendering.Renderers
{
    ...
    /// 
    /// 
    /// The only curious part is the way the tiling is done. Infantry Online floor tiles are 16x16 pixels, but the
    ...
    internal class FloorRenderer
    {
        ...
        public FloorRenderer(Device device, Size initialSize)
        {
            ...
            int tileCountX = 2048; // initialSize.Width / Grid.PixelsPerCell - TODO: Uncomment this when viewport resizing works.
            int tileCountY = 2048; // initialSize.Height / Grid.PixelsPerCell - TODO: Uncomment this when viewport resizing works.
        ...
        public void Render(Grid.GridRange range, Rectangle viewport)
        {
            ...
            foreach(Grid.GridCell cell in range)
            {
                ...
                float scaleW = 16.0f/image.Image.Width;
                float scaleH = 16.0f/image.Image.Height;
        ...
        public void Dispose()
        {
            ...
            if (vertexDecl != null && !vertexDecl.Disposed)
            {
                vertexDecl.Dispose();
            }
        }
