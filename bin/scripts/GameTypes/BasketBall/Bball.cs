...
{	// Script Class
    ...
    {	///////////////////////////////////////////////////
        ...
        {	//We've started!
            ...
            int terrainNum = ball._arena.getTerrainID(ball._state.positionX, ball._state.positionY);
            if (player._team == team1)
            {
                if (terrainNum >= 5 && terrainNum <= 8)
                {
                    team1Goals = team1Goals + 2;
                }
                else
                {
                    team1Goals = team1Goals + 3;
                }
            }

            if (player._team == team2)
            {
                if (terrainNum >= 1 && terrainNum <= 4)
                {
                    team2Goals = team2Goals + 2;
                }
                else
                {
                    team2Goals = team2Goals + 3;
                }
            }
            ...
            if (!_overtime)
            {
                ...
                //Mercy Rule
                if (team1Goals > (team2Goals + 49))
                    _arena.gameEnd();
                else if (team2Goals > (team1Goals + 49))
                    _arena.gameEnd();
            }
        ...
        private void deadBallTimer(Ball ball)
        {
            ...
            //Are we stuck in/on a wall or corner?
            int terrainNum = ball._arena.getTerrainID(x, y);
