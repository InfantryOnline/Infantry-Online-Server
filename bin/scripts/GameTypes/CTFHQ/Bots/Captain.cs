    ...
    class Captain : Bot
    {
        ...
        public override bool poll()
        {
            ...
            {//Dead
                ...
                ctfhq.captainBots.Remove(_team); //Signal our game script that a captain needs to be respawned
            ...
            {//No enemy, defend and patrol or go back to base
                ...
                {//Patrol
                    ...
                    if (owner != null && ctfhq.botCount.ContainsKey(_team) && ctfhq.botCount[_team] < ctfhq._hqs[_team].Level - 3 && now - _tickLastSpawn > 4000)
                    {//Not a bot team
                        ctfhq.addBot(owner, _state, null);
                        _tickLastSpawn = now;
                    }
                    else if (owner == null && ctfhq.botCount.ContainsKey(_team) && ctfhq.botCount[_team] < ctfhq._hqs[_team].Level - 3 && now - _tickLastSpawn > 4000)
                    {//Bot team 
                        //should probably get rid of owner for all bots
                        ctfhq.addBot(null, _state, _team);
                        _tickLastSpawn = now;
                    }
