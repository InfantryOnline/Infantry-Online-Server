...
namespace InfServer.Logic
{
    class Logic_ChatCommands
    {
        ...
        private static void Handle_CS_ChatQuery_Wipe(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            if (String.IsNullOrWhiteSpace(pkt.payload))
            {
        ...
        private static void Handle_CS_ChatQuery_ModChat(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_SendAlert(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            string pAlias;
        ...
        private static void Handle_CS_ChatQuery_GetHelpCalls(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_GetBans(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            if (pkt.payload == "")
                return;
        ...
        private static void Handle_CS_ChatQuery_CommandHistory(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_History(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            const int resultsPerPage = 30;
            string[] args = pkt.payload.Split(':');
            string name = args[0];
        ...
        private static void Handle_CS_ChatQuery_Find(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            int minlength = 3;
        ...
        private static void Handle_CS_ChatQuery_EmailUpdate(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_DeleteAlias(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
            if (string.IsNullOrWhiteSpace(pkt.payload))
            {
        ...
        private static void Handle_CS_ChatQuery_Whois(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_AccountIgnore(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
        ...
        private static void Handle_CS_ChatQuery_AccountInfo(CS_ChatQuery<Zone> pkt, Zone zone, InfantryDbContext db)
        {
