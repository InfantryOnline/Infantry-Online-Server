...
namespace InfServer.Logic
{
	...
	{	///////////////////////////////////////////////////
		...
		/// </summary>
		static public int binToInventory(List<PlayerStats.InventoryStat> invlist, byte[] bin)
		...
		/// </summary>
		static public byte[] inventoryToBin(List<PlayerStats.InventoryStat> invlist)
		...
		/// </summary>
		static public int binToSkills(List<PlayerStats.SkillStat> skilllist, byte[] bin)
		{	//Convert to a byte array
		...
		/// </summary>
		static public byte[] skillsToBin(List<PlayerStats.SkillStat> skilllist)
		{	//Create a new byte array
